    ...
    , m_knowledgeBase(nullptr)
{
    ...
    setWindowTitle("Задача о ферзях. Пункт 2");  // Устанавливаем заголовок окна
    resize(1200, 800);            // Начальный размер окна
}
...
void MainWindow::setupUI()
{
    ...
    m_resetKnowledgeButton = new QPushButton("Сбросить", this);
...
void MainWindow::onSolutionsSorted(bool ascending)
{
    if (m_solver) {
        ...
        appendToConsole(QString("\n╔══════════════════════════════════════════════════════════════╗"));
        appendToConsole(QString("║  РЕЗУЛЬТАТЫ СОРТИРОВКИ                                      ║"));
        appendToConsole(QString("╠══════════════════════════════════════════════════════════════╣"));
...
{
    //qDebug() << "generateDefaultAllGreen() called";
    ...
    //qDebug() << "All green done, board size:" << boardSize;
    //qDebug() << "Is valid?" << m_knowledgeBase->isValid();
}
